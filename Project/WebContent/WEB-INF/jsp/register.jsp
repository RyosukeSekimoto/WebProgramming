            ...
            <div class="register-wrapper">
                <div class="register-box">
                    <form action="/UserManagement/Register" method="post">
                        ...
                        <p class="loginId"><input type="text" name="loginId" value="<c:out value="${formValues.loginId}" />"/></p>
                        ...
                        <p class="name"><input type="text" name="name" value="<c:out value="${formValues.name}" />"/></p>
                        <p class="form-label">生年月日</p>
                        <p class="birthDate"><input type="date" name="birthDate" value="<c:out value="${formValues.birthDate}" />"/></p>
                        <input type="hidden" name="createDate" value="<c:out value="${System.currentTimeMillis()}" />">
